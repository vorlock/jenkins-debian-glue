...
# Purpose: provide simple gateway between GitHub and an internal Jenkins
# server to receive git push actions from GitHub and trigger Jenkins jobs
# accordingly. Place this script on a host which is available from GitHub
# and has access to the internal Jenkins system as well.

# Instructions for usage:
# * configure hook_server settings via config.yml
# * adapt this script if necessary
# * get dependencies: bundle install --path=bundled --verbose --binstubs
# * start service: bundle exec ./hook_server.rb
